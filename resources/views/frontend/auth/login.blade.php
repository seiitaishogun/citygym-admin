        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.login')" novalidate>
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">@lang('E-mail Address')</label>

                                <div class="col-md-6">
                                    <input type="email" name="email" id="email" class="form-control" placeholder="{{ __('E-mail Address') }}" value="{{ old('email') }}" maxlength="255"  />
                                </div>
                            </div><!--form-group-->

...
@section('content')
    <form action="{{ route('admin.news.add_action') }}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row">
        <div class="col-8">
            <div class="card card-accent-primary">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('title') is-invalid @enderror" id="title-input" type="text"
                               name="title" value="{{ old('title') }}" placeholder="@lang('news.vn_title_holder')" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="display_url-input" type="text" name="display_url"
                               value="{{ old('display_url') }}" placeholder="@lang('news.vn_display_url_holder')" >
                    </div>

                    <div class="form-group">
                        <label for="textarea-input">@lang('news.content')</label>
                        <textarea class="content" id="textarea-input" name="content" rows="9"
                                  placeholder="@lang('news.vn_content_holder')">{{ old('content') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="form-check checkbox">
                            <input class="form-check-input" id="chkurl_display" type="checkbox" name="is_url_display" value="1">

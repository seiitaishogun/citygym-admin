...
@section('title', __('news.edit_manual'))

@section('content')
    <form action="{{ route('admin.manual.edit_action', [$item->new_id]) }}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row">
        <div class="col-8">
            <div class="card card-accent-primary">
                <div class="card-body">
                    ...
                    <!--<div class="form-group">
                        ...
                        <div class="row">
                            @if(!empty($item->meta['vn']->image))
                                <div class="col-12 mt-xxl-2">
                                    <img src='{{ asset('storage'.$item->meta->image->full_img) }}' class="img-thumbnail" style="max-width: 450px">
                                </div>
                            @endif
                        </div>
                    </div>-->

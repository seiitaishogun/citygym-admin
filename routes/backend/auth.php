...
use App\Domains\Acp\Http\Controllers\Backend\Auth\LoginController;

Route::group(['middleware' => 'auth'], function () {
    // Authentication
    Route::post('logout', [LoginController::class, 'acplogout'])->name('logout');
});
...
Route::group([
    ...
    Route::get('edit-password', [\App\Domains\Acp\Http\Controllers\Backend\Auth\ChangePasswordController::class, 'edit'])
        ->name('edit-password');

    Route::patch('edit-password', [\App\Domains\Acp\Http\Controllers\Backend\Auth\ChangePasswordController::class, 'update'])
        ->name('edit-password.update');
});

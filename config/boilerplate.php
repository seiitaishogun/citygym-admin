...
/*
 * All configuration options for Laravel
 */
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configurations related to the news system
    */
    'news' => [
        /*
         * Default thumbnail size of the news if none is supplied
         */
        'thumb_width' => 100,
        'thumb_height' => 100
    ],
